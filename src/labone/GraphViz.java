 ...
 * </dl>
 *
 * @author Laszlo Szathmary (<a href="jabba.laci@gmail.com">jabba.laci@gmail.com
 * </a>)
...
public class GraphViz {
     ...
     */
    private final int[] dpiSizes = {46, 51, 57, 63, 70, 78, 86, 96, 106, 116
, 128, 141, 155, 170, 187, 206, 226, 249};
     ...
     * Windows:
     * executable = c:/Program Files (x86)/Graphviz 2.38/bin/dot.exe
     * tempDir = c:/temp
     * MacOs:
    ...
    public GraphViz() {
        if (GraphViz.osName.contains("Windows")) {
            this.tempDir = "C:/Users/zhou/Desktop/tmp";
            this.executable = "D:/graphviz/release/bin/dot.exe";
    ...
    public void changeAll(String graph_string, String new_graph_string) {
        int index1 = this.graph.indexOf(graph_string);
        int index2 = this.graph.indexOf(new_graph_string);
        if (index1 != index2) {
            this.graph.replace(index1, index1 + graph_string.length(), new_graph_string);
        }
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException {
        ...
        try {
            temp = File.createTempFile("graph_", ".dot", new File(this.tempDir));
